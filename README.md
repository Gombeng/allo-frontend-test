...
- As a user, I want to see a list of rockets in the rocket list screen (Show each rocket image, rocket name, and rocket description) | DONE
- As a user, I want to be able to filter the rockets in the rocket list screen | filter by? name DONE
- As a user, I want to be able to add the new rocket in the rocket list screen | DONE
- As a user, I want to be able to see the rocket detail by clicking a rocket in the rocket list screen (Show rocket image, rocket name, rocket description, cost per launch, country, first flight) | DONE

### Non-Functional Requirements
- Use Space-X API (https://github.com/r-spacex/SpaceX-API) for getting the rocket data | DONE 
- Implement routers | DONE 
- Implement state management | DONE
- Implement lifecycles | DONE
